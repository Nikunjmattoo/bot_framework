    ...
    test_suites = [
        {
            ...
            "dir": "test/utils/",
            "description": "Utility functions, validation, sanitization, datetime"
        },
        {
        ...
        },
        {
            ...
            "description": "End-to-end flows, error scenarios, security, performance"
        }
    ]
...
def show_help():
    ...
    print("  utils               Utils (validation, sanitization, datetime)")
    ...
    print("  integration         Integration Tests (end-to-end, security)")
    print()
