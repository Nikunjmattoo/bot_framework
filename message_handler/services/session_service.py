    ...
    try:
        ...
        expired_sessions = (db.query(SessionModel)
            .filter(
                ...
                SessionModel.expired_at < cutoff_date
            )
            .limit(batch_size)
            .all())
...
def get_session_info(
    ...
    try:
        ...
        session_info = {
            ...
            "has_token_plan": session.token_plan_json is not None,
            "has_template_requests": session.requested_templates is not None,
        }
